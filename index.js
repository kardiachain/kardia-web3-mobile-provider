...
class KardiaChainWeb3Provider extends EventEmitter {
  constructor(config) {
    super();
    ...
    switch (payload.method) {
      ...
      default:
        throw new ProviderRpcError(
          4200,
          `KardiaChain Wallet does not support calling ${payload.method} synchronously without a callback. Please provide a callback parameter to call ${payload.method} asynchronously.`
        );
    }
    return response;
  }
    ...
    return new Promise((resolve, reject) => {
      ...
      switch (payload.method) {
        ...
        case "eth_subscribe":
          throw new ProviderRpcError(
            4200,
            `KardiaChain Wallet does not support calling ${payload.method}. Please use your own solution`
          );
        default:
          // call upstream rpc
